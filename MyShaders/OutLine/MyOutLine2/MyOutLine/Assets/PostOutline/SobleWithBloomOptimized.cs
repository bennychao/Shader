...
namespace UnityStandardAssets.ImageEffects
{
    ...
    [AddComponentMenu ("Image Effects/Bloom and Glow/Soble With Bloom (Optimized)")]
    public class  SobleWithBloomOptimized : PostEffectsBase
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
			...
			fastBloomMaterial.SetColor ("_OutlineColor", _OutLineColor);

            // downsample and filter the color with w > 0
			...
			Graphics.Blit (rt, rt1, fastBloomMaterial, 6);
